 ...
 * @author Ana Teresa
 */
public class Caramelo extends HeladoDecorador {

    public Caramelo(Component_Heladeria heladeria) {
        super(heladeria);
    }
    ...
    public String getDescripcion() {
        return super.getHeladeria().getDescripcion() + " + caramelo derretido ";
    }
    ...
    public int getPrecio() {
        return super.getHeladeria().getPrecio() + 100;
    }
