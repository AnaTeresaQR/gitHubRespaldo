 ...
 * @author Ana Teresa
 */
public class Botonetas extends HeladoDecorador {

    public Botonetas(Component_Heladeria heladeria) {
        super(heladeria);
    }
    ...
    public String getDescripcion() {
        return super.getHeladeria().getDescripcion() + " + botonetas ";
    }
    ...
    public int getPrecio() {
        return super.getHeladeria().getPrecio() + 170;
    }
